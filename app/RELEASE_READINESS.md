...
- Website: `https://geardrop.100app.dev`, current seven-path HTTP 200 readback; dynamic catalog API `X-Code-Revision=20d917237fb8141492b323b0ae1356b59808739a`, while the independent static data publication reports its own snapshot source revision. The homepage, catalog API, Arc'teryx aggregation page and pants category page returned HTTP 200.
- Latest observed data publication: revision `11f6088ea7b82270f0f7`, artifact `5695ad547c80e895e1bc`, publication source `ae306995aa91cb6526d4af378f0c7b630605275c`, 6,791 active products; evidence `web-current-build14.json`. The static publication/data-status pair agrees on this snapshot; the API returns the same data revision. Earlier in this release all 604 category repairs applied with zero concurrent skips/readback errors, the independent subsequent repair plan had zero remaining changes, and public static/API categories agreed. These are timestamped observations, not permanent live values.
