...
export function defaultImageKind(category?: string | null): DefaultImageKind {
  ...
  // Match the concrete product type before activity labels such as
  // "snowboard" and broad catalog labels such as "tops" or "bottoms".
  if (/shoe|boot|footwear|sandal|鞋/.test(value)) return "shoes";
