...
const ALERT_COPY: Record<AppLanguage, AlertSheetCopy> = {
  ...
  fr: { title: 'Alerte de prix', itemScope: 'Cet article', modelScope: 'Toute offre du modèle', current: 'Actuel', target: 'Devise cible', tenPercent: '−10 %', historyLow: 'Plus bas historique', custom: 'Personnalisé', local: 'Notification locale', background: COPY.fr.backgroundTiming, emailOptional: 'E-mail (article uniquement)', invalidEmail: 'Saisissez une adresse e-mail valide.', targetBelow: 'Le prix cible doit être inférieur au prix actuel.', chooseChannel: 'Choisissez au moins un mode de notification.', permissionDenied: 'Autorisez les notifications dans les réglages système.', limitReached: 'Limite gratuite atteinte', proUnlimited: 'Pro inclut des alertes illimitées.', cancel: 'Annuler', save: 'Enregistrer', quota: (used, limit, pro) => pro ? `${used} actives · Pro illimité` : `${used} alerte gratuite sur ${limit}` },
